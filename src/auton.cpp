...
//111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
  ...
  if (atn == 0) {
    ...
    //test
      ...
      RunpidStraightNTo(100,990,10,100,400,0,0,1500,0,39);
      delay(200);
      TurnVolpidNTo(100,90, 1, 1000,30);
      Fintake.move(127);
      Mintake.move(127);
     ...
     scraper.set_value(true);
      delay(200);
      RunpidStraightNTo(60,550,20,100,400,0,0,800,0,39);
      delay(600);
      ...
      Mintake.move(-127);
      //1st long horizontal
      RunpidStraightNTo(70,3265,30,100,400,0,0,4000,0,39);
      ...
      //scrape 2nd loader
      scraper.set_value(true);
      RunpidStraightNTo(60,730,20,100,400,0,0,800,0,39);
      delay(600);
      RunpidStraightNTo(100,100,20,100,400,0,0,1200,0,39);
      delay(200);
      ...
      delay(200);
      RunpidStraightNTo(100,558,20,100,400,0,0,800,0,39);
      //score 2nd goal
      blocker.set_value(true);
      delay(1600);
      RunpidStraightNTo(100,-300,20,100,400,0,0,1000,0,39);
      delay(400);
      TurnVolpidNTo(100, -150, 1, 800,30);
      delay(60);
      RunpidStraightNTo(100,550,20,100,400,0,0,1000,0,39);
      delay(400);
      TurnVolpidNTo(100, -87, 1, 800,30);
      //2nd long vertical
      RunpidStraightNTo(70,2500,20,70,400,0,0,2000,0,39);
      delay(200);
      TurnVolpidNTo(100, -30, 1, 800,30);
      delay(200);
      RunpidStraightNTo(70,465,20,70,400,0,0,2000,0,39);
      delay(200);
      TurnVolpidNTo(100, -92, 1, 800,30);
      blocker.set_value(false);
      //3rd loader
      scraper.set_value(true);
      ...
      delay(200);
      //3rd long horizontal
      RunpidStraightNTo(50,3365,50,100,400,0,0,4000,0,39);
      colorSorter.set_value(false);
      Fintake.move(127);
      Mintake.move(127);
      delay(150);
      TurnVolpidNTo(100, 88, 1, 800,30);
      RunpidStraightNTo(100,540,20,100,400,0,0,1200,0,39);
      ...
      //scrape 4th goal
       scraper.set_value(true);
      RunpidStraightNTo(60,700,20,100,400,0,0,800,0,39);
      delay(600);
      RunpidStraightNTo(100,100,20,100,400,0,0,1200,0,39);
      delay(200);
      RunpidStraightNTo(100,-800,20,100,400,0,0,500,0,39);
      ...
      delay(200);
      //4th long horizontal
      RunpidStraightNTo(70,4150,20,70,400,0,0,4000,0,39);
      delay(200);
    ...
    //middle goal safe 
     Fintake.move(127);
      ...
      RunpidStraightNTo(30,470,5,75,400,0,0,1000,0,39);
      RunpidStraightNTo(30,-140,5,50,400,0,0,1000,0,39);
      ...
      delay(290);
      scraper.set_value(false);
      RunpidStraightNTo(100,-1590,20,100,400,0,0,4000,0,39);
      delay(100);
      ...
      scraper.set_value(true);
      delay(200);
      RunpidStraightNTo(50,700,20,30,400,0,0,1000,0,39);
      delay(600);
      RunpidStraightNTo(100,100,20,100,400,0,0,1200,0,39);
      delay(100);
      RunpidStraightNTo(100,-300,20,100,400,0,0,1000,0,39);
      scraper.set_value(false);
      TurnVolpidNTo(100, -4, 1, 1000,19);
      RunpidStraightNTo(100,605,20,100,400,0,0,1000,0,39);
      blocker.set_value(true);
      delay(1200);
      colorSorter.set_value(true);
  }
    ...
    //Blue right elims
      Fintake.move(127);
      Mintake.move(127);
      RunpidStraightNTo(30,300,10,30,400,0,0,1000,0,39); //orig 280
      RunpidStraightNTo(100,450,10,100,400,0,0,1000,46,39); //49 original
      RunpidStraightNTo(100,1000,10,100,400,0,0,4000,0,39);
      RunpidStraightNTo(30,260,10,30,400,0,0,1000,0,39);
      RunpidStraightNTo(100,-550,10,100,400,0,0,4000,0,39);
      TurnVolpidNTo(100, -45, 1, 800,34);
      delay(200);
      //scraper.set_value(false);
      Fintake.move(127);
      Mintake.move(127);
      RunpidStraightNTo(100,-970,10,100,400,0,0,2400,0,39);
      delay(100);
      TurnVolpidNTo(100,-179, 1, 1000,34);
      scraper.set_value(true);
      delay(300);
      RunpidStraightNTo(60,640,20,100,400,0,0,950,0,39);
      delay(600);
      RunpidStraightNTo(100,-800,20,100,400,0,0,500,0,39);
      scraper.set_value(false);
      TurnVolpidNTo(100,-1, 1, 1000,19);
      RunpidStraightNTo(100,284,20,100,400,0,0,1000,0,39);
      blocker.set_value(true);
      Fintake.move(127);
      Mintake.move(127);
      ...
      // Fintake.move(127);
      // Mintake.move(127);
      // RunpidStraightNTo(100,-1540,20,100,400,0,0,4000,0,39);
      // scraper.set_value(true);
      // linkage.set_value(false);
      // delay(50);
      // TurnVolpidNTo(100,-179, 1, 1000,34);
      // delay(50);
      // RunpidStraightNTo(100,620,20,100,400,0,0,1000,0,39); //was 700
      // delay(800);
      // RunpidStraightNTo(100,50,20,100,400,0,0,1000,0,39);
      // delay(200);
      // RunpidStraightNTo(100,-300,20,100,400,0,0,1000,0,39);
      // scraper.set_value(false);
    ...
    //Full awp tuned on blue
      RunpidStraightNTo(100,1050,10,100,400,0,0,2000,0,39);
      Fintake.move(-127);
      Mintake.move(-127);
      delay(300);
      ...
      TurnVolpidNTo(100, -64, 1, 800,34);
      Fintake.move(127);
      Mintake.move(127);
      RunpidStraightNTo(70,1380,10,30,400,0,0,2000,0,39);
      TurnVolpidNTo(100, 49, 1, 800,34);
      Fintake.move(0);
      Mintake.move(0);
      linkage.set_value(true);
      scraper.set_value(true);
      RunpidStraightNTo(100,350,10,100,400,0,0,500,0,39);
      Fintake.move(-127);
      Mintake.move(-127);
      delay(100);
      Fintake.move(90);
      ...
      scraper.set_value(false);
      linkage.set_value(false);
      RunpidStraightNTo(100,-1470,10,100,400,0,0,2000,0,39);
      Fintake.move(127);
      Mintake.move(127);
      delay(100);
      TurnVolpidNTo(100,-179, 1, 1000,34);
  ...
  //red left elims with push
   ...
   /*else if (atn == 1) { //auton that is for field 1 specifically
    //middle goal safe 
     Fintake.move(127);
      Mintake.move(127);
      //derrick was here
      ...
      delay(290);
      scraper.set_value(false);
      RunpidStraightNTo(100,-1630,20,100,400,0,0,4000,0,39);
      delay(100);
      TurnVolpidNTo(100,179, 1, 1000,34);
      linkage.set_value(false);
      //scraper 
