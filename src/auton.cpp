...
//---------------------------------------------------------------------------------------------------------------------------------------
  ...
  if (atn == 0) {
    ...
    Lever.move(-65);
    scraper.set_value(true);
    drivePIDW(1350, 60, 1500, 500, -1, -1, -1, -1, 15, 50, 1, 675, 30, 0, -1, 0);
    Lever.move(0);
   ...
   //6+3 right
    ...
    Lever.move(-65);
    scraper.set_value(true);
    drivePIDW(1370, 50, 1900, 472, -1, -1, -1, -1, 15, 50, 0, 675, 30, 0, -1, 0);
    Lever.move(0);
    drivePIDW(-100, 127, 500, 472, -1, -1, -1, -1, 15, 50, 0, 300, 60, -200, -1, 0); 
    scraper.set_value(false);
    turnPID(286, 75, 900, 1.6, 40, 0);
    drivePID(2080, 127, 1300, 150, 10, 600, 90, 0, -1, 0);
    intake.move(-100);
    pros::delay(200);
    drivePID(-150, 127, 1300, 75, 10, 100, 90,-20, -1, 0);
    drivePID(200, 127, 1300, 75, 10, 100, 127, 0, -1, 0);
    pros::delay(300);
   ...
   intake.move(127);
    ...
    scraper.set_value(false);
    turnPID(286, 75, 900, 1.6, 40, 0);
    drivePID(2100, 127, 1300, 150, 10, 600, 90, 0, -1, 0);
    intake.move(-127);
    pros::delay(200);
    drivePID(-150, 127, 1300, 75, 10, 100, 90,-20, -1, 0);
    drivePID(200, 127, 1300, 75, 10, 100, 127, 0, -1, 0);
    ...
    drivePID(620, 127, 1500, 10, 50, 200, 80, 200, -1, 0);
    scraper.set_value(true);
    turnPID(90, 75, 600, 1.6, 30, 3); 
    scraper.set_value(false);
    drivePID(870, 200, 1500, 10, 50, 350, 100, 200, -1, 0);
    turnPID(143, 75, 400, 1.6, 30, -2); 
    scraper.set_value(true);
    drivePIDW(1350, 60, 1900, 455, -1, -1, -1, -1, 15, 50, 0, 675, 30, 0, -1, 0);
    drivePIDW(-1200, 127, 500, 405, -1, -1, -1, -1, 15, 50, 0, 599, 65, -100, -1, 0); 
    LF.move(-80);
    LM.move(-80);
    LB.move(-80);
    RF.move(-80);
