...
//111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
  ...
  if (atn == 0) {
   ...
   TurnVolpidNTo(100, -45, 1, 500,36);
    RunpidStraightNTo(100,800,40,60,400,0,0,2000,0,39);
    lift.set_value(true);
    ...
    RunpidStraightNTo(100,1600,30,30,400,0,0,4000,0,39);//1600
...
//red left///////
  ...
  Lintake.move(127);
  Rintake.move(-127);
  RunpidStraightNTo(100,930,100,10,400,0,0,2000,0,39);
  delay(50);
  ...
  scraper.set_value(false);
  delay(500);
  TurnVolpidNTo(100, -165, 1, 900,30);
  delay(50);
  pto.set_value(true);
  RunpidStraightNTo(100,1975,80,50,400,0,0,3000,-13,39);//1945,-10
   delay(25);
    ...
    RunpidStraightNTo(100,1460,100,60,400,0,0,2200,0,39);
    delay(50);
...
//7 ball right RRRRRRR
    ...
    delay(25);
    //  drive_to_point(-13.5, -13.5, 100, 100, 80, 1, 0, 1000, 1, 1, 10, 0,0);
    RunpidStraightNTo(100,1105,30,60,400,0,0,2000,0,39);//1600
    delay(50);
    TurnVolpidNTo(100, 180, 1, 300,37);
    delay(25);
    ...
    //RunpidStraightNTo(100,1300,30,60,400,0,0,2000,0,39);//1600
    // delay(50);
    // TurnVolpidNTo(100, -179, 1, 300,37);
    // delay(25);
    // RunpidStraightNTo(100,-1100,40,60,400,0,0,1500,0,39);
